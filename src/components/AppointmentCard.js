...
const AppointmentCard = ({ apt }) => (
  <div className="bg-white flex justify-between items-center max-w-lg rounded-md px-2 py-3 md:py-1">
    {parseJSON(apt.time) > Date.now()
      ? (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-exclamation-circle fill-gray text-xs md:text-sm w-8" viewBox="0 0 16 16">
